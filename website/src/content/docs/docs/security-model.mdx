...
description: A short overview of Secure Exec isolation and trust.
---
...
The runtime trust boundary is sidecar to executor: host configuration is trusted,
while guest code and the packages it loads are untrusted.
