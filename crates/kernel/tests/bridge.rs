...
where
    B: HostBridge,
    <B as secure_exec_kernel::bridge::BridgeTypes>::Error: Debug,
{
    let contents = bridge
    ...
    let metadata = bridge
        ...
        .expect("stat");
    assert_eq!(metadata.kind, secure_exec_kernel::bridge::FileKind::File);
    ...
    assert_eq!(
        ...
        secure_exec_kernel::bridge::PermissionDecision::allow()
    );
    assert_eq!(
        bridge
    ...
    let execution = bridge
        .start_execution(secure_exec_kernel::bridge::StartExecutionRequest {
            vm_id: String::from("vm-1"),
    ...
    bridge
        ...
        .expect("close stdin");
    bridge
        .kill_execution(secure_exec_kernel::bridge::KillExecutionRequest {
            vm_id: String::from("vm-1"),
...
fn host_bridge_traits_are_method_oriented_and_composable() {
    ...
    bridge.seed_directory(
        ...
        vec![DirectoryEntry {
            ...
            kind: secure_exec_kernel::bridge::FileKind::File,
        }],
    );
